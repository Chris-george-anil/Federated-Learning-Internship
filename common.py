...
def compute_epsilon(
    ...
    rdp = compute_rdp( #gaussian mechanism
    ...
    print("rdp",rdp)
    sns.displot(rdp)
    return get_privacy_spent(orders, rdp, target_delta=1 / num_train_examples)[0]  #returns epsilon and delta
